...
export default function ContextoATK(){
  return(
    <View style={{flex: 1, alignItems: 'center', justifyContent:'center'}}>
      <Text 
       onPress={() => alert('Você está na tela de contexto.')}
       style={{fontSize: 26, fontWeight: 'bold', marginTop: -200, backgroundColor: '#f54242', color: 'white'}}> CONTEXTO </Text>
       <Text style={{fontSize: 20, padding: 15}}> Seu objetivo é atacar! </Text>
